...
#Region " Variables "
   ...
   ''' </summary>
   Private animator As ModFormAnimator
...
#Region " Constructors "
    ...
    Public Sub New(ByVal lifeTime As Integer, ByVal message As String)
      ...
      Me.animator = New ModFormAnimator(Me, _
                                     ModFormAnimator.AnimationMethod.Slide, _
                                     ModFormAnimator.AnimationDirection.Up, _
                                     500)
    End Sub
...
#Region " Event Handlers "
    ...
    Private Sub ToastForm_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        ...
        Me.animator.Direction = ModFormAnimator.AnimationDirection.Down
    End Sub
